package team.tsinghua.ipsc.bipolar_disorder_detector.map;
...
import team.tsinghua.ipsc.bipolar_disorder_detector.util.AMapUtil;
import team.tsinghua.ipsc.bipolar_disorder_detector.util.ToastUtil;
...
public class PoiKeywordSearchActivity extends FragmentActivity implements
	...
	private void init() {
		if (aMap == null) {
			aMap = ((MapFragment) getFragmentManager()
